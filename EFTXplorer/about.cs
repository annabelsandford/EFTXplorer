...
namespace EFTXplorer
{
    public partial class about : Form
    {
        ...
        private void about_Load(object sender, EventArgs e)
        {
            ...
            textBox1.Text = "EFTX is licensed through AGPL 3.0" + frm1.nwln + "You can distribute modified versions of EFTX if you keep track of the changes, the date you made them and distribute source code along with modified publications. You must include EFTX's as well as EFT2RGBA's original authors as the first copyright holders in any deriviates published. Please refrain from republishing unmodified code or executables.";
        }
